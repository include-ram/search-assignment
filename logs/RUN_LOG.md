...
> The evidence cells pull from O\*NET 15-1252.00 and job posting patterns that Claude Code searched live during the session. Honestly, I didn't personally open every URL and verify the exact quotes — I trusted what the agent pulled. That's a gap in my own verification. Before I submit, I'm going to open at least one or two of those sources myself and confirm the cited requirements actually appear there.
